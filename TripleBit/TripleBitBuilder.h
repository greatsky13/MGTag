...
public:
	...
	static inline void loadTwo(const char* data, ID& v1, ID& v2) {
		TempFile::readId(TempFile::readId(data, v1), v2);
	}

	//////°¡
	static inline void loadData(const char* data, ID& v1) {
		TempFile::readId(data, v1);
	}
	//////°¡
