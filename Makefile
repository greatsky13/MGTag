...
CPPFLAGS := -g -O3 -lm  #`raptor-config --cflags` 
#CPPFLAGS := -g
LIBS :=  -lpthread  
...
LINK.cpp = $(COMPILER) $(LIBS) -g -O3 -lm
...
modules      := TripleBit TripleBitQuery BuildFromN3  TripleBitServer \
				Matrix Algorithm ZTest Feline
programs     := 
libraries    :=
sources      :=
